...
export default function Register() {
  ...
  const { register, handleSubmit,setValue, formState:{ errors, isSubmitting } } = useForm<registerFormSchemaData>({
    ...
    <Container>
      ...
      <Form as='form' onSubmit={handleSubmit(handleRegister)}>
        <label >
          ...
          <TextInput {...register('username')} prefix="ignite.com/" placeholder="seu-usuário"/>
          {errors.username && (
            <FormError size="sm">
